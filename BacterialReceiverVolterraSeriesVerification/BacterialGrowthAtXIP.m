...
%% Heuristic for XIP Influence on Bacterial Growth
...
%% Fit Bacterial Growth Curves to Experimental Data
...
% Save Bacterial Grwoth Curve for later use
...
text(6e7, 0.2, txt, 'BackgroundColor',[0.9290 0.6940 0.1250])
title("ODE600 CFU Standard Curve")


% Create Optimization Variable
r = optimvar('r',4, Type='continuous', LowerBound=[0.006,7,0.9,0.8],UpperBound=[0.05,8,1.1,2]);
...
%% Plot Solution for Fitted Parameters vs Experimental Data 
